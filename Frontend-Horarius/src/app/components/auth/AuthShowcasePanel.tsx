  ...
  return (
    <section className="hidden min-h-[42rem] overflow-hidden rounded-lg bg-[#8f2449] p-7 text-white lg:grid lg:grid-rows-[auto_1fr] xl:p-9">
      ...
      <div className="mt-10 grid min-h-0 gap-8 xl:grid-cols-[0.72fr_1.28fr] xl:items-center">
        ...
        <div className="self-center overflow-hidden rounded-lg border border-black/10 bg-[#f8f9fb] text-[#181a20] shadow-[0_28px_70px_-32px_rgba(21,22,38,0.65)]">
          ...
          <div className="grid grid-cols-[minmax(0,1fr)_8.5rem]">
                  ...
                  <div className="border-l-2 border-[#a72c53] pl-3">
                    <div className="flex items-start justify-between gap-2">
                      <div>
                        ...
                        <p className="mt-1 text-xs text-[#6b6f7b]">{appointment.service}</p>
                      </div>
            ...
            <aside className="border-l border-black/[0.07] bg-white px-4 py-5">
              ...
              <div className="mt-6 border-t border-black/[0.07] pt-4">
                <p className="flex items-center gap-1 text-[0.68rem] font-bold text-[#4f7d16]">

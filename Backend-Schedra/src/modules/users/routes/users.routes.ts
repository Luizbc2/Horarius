...
const createUserService = new CreateUserService(userRepository, tenantService);
const updateUserProfileService = new UpdateUserProfileService(userRepository);
const usersController = new UsersController(createUserService, updateUserProfileService, sessionService);
